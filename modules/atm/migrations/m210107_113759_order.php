...
/**
 * Class m210107_113759_order
 */
class m210107_113759_order extends app\modules\atm\migrations\Migration
{
    ...
    {
        if (\Yii::$app->getModule('atm')->db->schema->getTableSchema($this->tableName, true) === null) {
